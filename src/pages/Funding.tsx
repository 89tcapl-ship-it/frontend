...
const fundingServices = [
  { title: "Startup Funding", description: "Capital raising support for growth-stage businesses.", icon: PiggyBank, slug: "startup-funding" },
  { title: "Due Diligence", description: "Financial and compliance review support.", icon: ShieldCheck, slug: "due-diligence" },
  { title: "Valuation", description: "Business valuation for investors and stakeholders.", icon: Banknote, slug: "valuation" },
  { title: "FDI Compliance", description: "Regulatory guidance for foreign investment.", icon: ShieldCheck, slug: "fdi-compliance" },
  { title: "Bank Finance", description: "Loan documentation and finance support.", icon: Banknote, slug: "bank-finance" },
  { title: "Project Reports", description: "Detailed reports for lenders and investors.", icon: ClipboardList, slug: "project-reports" },
];
