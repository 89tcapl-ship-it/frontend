...
export const defaultPageContentSeed: PageContentSeed[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "We ensure every filing is accurate, timely, and fully compliant with regulations.",
        order: 11,
        isActive: true,
      },
      {
        ...
        content: "A dedicated advisor for your business, always available to answer your queries.",
        order: 12,
        isActive: true,
      },
      {
        ...
        content: "No hidden costs. Clear pricing for every service, upfront.",
        order: 13,
        isActive: true,
      },
      {
        ...
        content: "We help you scale by handling compliance so you can focus on business.",
        order: 14,
        isActive: true,
      },
      {
