...
export const defaultPageContentSeed: PageContentSeed[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { sectionId: "contact-email", title: "Email", content: "connect@89TCA.in", order: 2, isActive: true },
